...
def parser():
    ...
    #                        dest='Result',
    #                        help='result')
    argparser.add_argument('--strategy','-s', type=str,
                           required=True,
                           dest='strategy',
                           help='Transmission Strategy')
    ...
    return loop, ps, strategy


def file_read(case,loop_num,ps,user_type,res_type,opt):
    # x = np.array([])
    # y = np.array([])    
    # z = np.array([])
    x = []
...
def main(argv):
    ...
    loop, ps, strategy = parser()

    res = 'user'
    
    x_1_1,y_1_1 = file_read(1,loop,ps,1,res,0)
    x_1_2,y_1_2 = file_read(1,loop,ps,2,res,0)
    x_1_3,y_1_3 = file_read(1,loop,ps,3,res,0)
    x_2_1,y_2_1 = file_read(2,loop,ps,1,res,0)
    x_2_2,y_2_2 = file_read(2,loop,ps,2,res,0)
    x_2_3,y_2_3 = file_read(2,loop,ps,3,res,0)
    x_3_1,y_3_1 = file_read(3,loop,ps,1,res,0)
    x_3_2,y_3_2 = file_read(3,loop,ps,2,res,0)
    x_3_3,y_3_3 = file_read(3,loop,ps,3,res,0)
    ...
    if strategy == 'broadcast':
        ...
        plt.plot(x_1_1_opt,
                ...
                linewidth = 2,
                markersize = 10,
                label = 'Scenario 1, Estimation Based'
        )
        plt.plot(x_1_2_opt,
                y_1_2_opt,
                color = matlabcolormap.blue,
                ...
                linewidth = 2,
                markersize = 10,
                label = 'Scenario 2, Estimation Based'
        )
        plt.plot(x_1_3_opt,
                y_1_3_opt,
                color = matlabcolormap.yellow,
                ...
                linewidth = 2,
                markersize = 10,
                label = 'Scenario 3, Estimation Based')
    ...
    plt.savefig(str(res)+ '_' + str(strategy) + '_opt.png',bbox_inches='tight',dpi=300)
    plt.savefig(str(res)+ '_' + str(strategy) + '_opt.pdf',bbox_inches='tight',dpi=300)
    # plt.show()
