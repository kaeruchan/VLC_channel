...
module Simulation
    ...
    using Base: Ones, rand, cos, sin, acos, zeros
    using LinearAlgebra: norm
    using Distributions: Uniform

    include("ProjectVLC.jl")
    import .ProjectVLC.Channels: phi_rad, vlc_channel, theta_deg, shadow_check
    import .ProjectVLC.Parameters: ψ_c, ψ_05, I_DC, Nb, u_r, A_PD, β, height, device_height, N0, height_user_body, shoulder_width, led, user_coop
    import .ProjectVLC.Functions: dbm2watt
    export simu
    function simu(
        strategy::Int64,
        u_type::Int64,
        simulation_loop::Int64,
        Ps::Float64,
        N0::Float64,
        eve
        )
        ...
        return capacity_user_sum_simu, capacity_eve_simu, secrecy_simu
    end
end